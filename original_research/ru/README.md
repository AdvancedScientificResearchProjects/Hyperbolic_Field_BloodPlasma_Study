...
| [Галерея Фотографий](#галерея-фотографий) | [AI Анализ](../reports/2026-02-25_ai-analysis/report_ru.md) | [Экосистема ASRP](#экосистема-asrp) |
...
| Parameter / Параметр | Control / Контроль | Ch19 / Канал 19 | Ch21 / Канал 21 |
|----------|----------|----------|----------|
