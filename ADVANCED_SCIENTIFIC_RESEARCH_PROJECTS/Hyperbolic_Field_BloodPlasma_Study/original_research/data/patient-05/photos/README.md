...
[Dataset Info](#dataset-overview) | [Photo List](#photo-inventory) | [Protocol](../../../../../../original_research/data/patient-05/protocol_part-01.pdf) | [All Patients](../../README.md)
...
```mermaid
flowchart LR
    A["Night Session"] --> B["Irradiation<br/>Until 01:21:41"]
    B --> C["Photography<br/>01:37:50 - 01:47:10<br/>10 photos"]
```
